...
**Currently pursuing:**
- 🎓 Application to **Apple Developer Academy** at UniNa (2026/27 cohort)
- 🔐 **ePass** security certification & drone license (through school program)
...
> Full-stack school library management system — built, deployed, maintained in production.

**PHP · MySQL · HTML/CSS · JavaScript · InfinityFree**

- Role-based auth (admin / student) with secure session management
- Book catalog, loan tracking, student feedback system, announcements
- CSRF protection, rate limiting on login, input sanitization
- Live deployment with iterative debugging and real user testing
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Gguruji1985&show_icons=true&theme=dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&icon_color=58a6ff&text_color=c9d1d9)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Gguruji1985&layout=compact&theme=dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&text_color=c9d1d9)
...
| 🔐 | **ePass** Security Certification — in progress |
| 🚁 | Drone License — in progress |
| 🍎 | Apple Developer Academy UniNa — applicant (2026/27) |
...
Background in metalworking + networking fundamentals + active security training on TryHackMe (Active Directory, Windows admin, network pentesting) = a perspective most pure IT grads don't have.
